...
const nuxtPackageEntries = [
  ...
  },
  {
    ...
    typeExports: ['ConvexCallErrorKind', 'ConvexCallErrorInput', 'SerializedConvexCallError'],
    exactDeclaredExports: true,
  ...
  },
  {
    kind: 'runtime',
    subpath: './test',
    distJs: 'dist/runtime/test/index.js',
    distDts: 'dist/runtime/test/index.d.ts',
    valueExports: ['setupBetterConvexTest'],
    typeExports: [
    ...
    exactDeclaredExports: true,
    forbiddenNames: ['BetterConvexTestClient', 'createBetterConvexTestAuth'],
  },
  {
    kind: 'runtime',
  ...
  },
  {
    ...
    valueExports: ['createBetterConvexTestAuth', 'default', 'register'],
    typeExports: ['BetterConvexTestAuthInstance'],
    exactDeclaredExports: true,
    forbiddenNames: [],
  },
  {
...
const vuePackageEntries = [
  ...
  },
  {
    ...
    typeExports: ['ConvexCallErrorInput', 'ConvexCallErrorKind', 'SerializedConvexCallError'],
    exactDeclaredExports: true,
  ...
  },
  {
    ...
    typeExports: ['BetterConvexAttachment'],
    exactDeclaredExports: true,
