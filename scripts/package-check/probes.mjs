...
export function probeRootEntry(ctx) {
  ...
  writeFile(
    ...
    [
      ...
      '  UseConvexFileUploadOptions, UseConvexFileUploadReturn, UseConvexMutationOptions,',
      ...
      '  UseConvexFileUploadReturn<UploadUrlMutation>, UseConvexMutationOptions<never>,',
