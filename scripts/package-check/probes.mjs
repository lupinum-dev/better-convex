...
export function probeRootEntry(ctx) {
  ...
  writeFile(
    ...
    [
      ...
      'import type {',
      '  AuthComponentTriggers, AuthCtx, AuthFunctions, CreateAuth, CreateBetterConvexAuthOptions, OAuthLiveAccess, VerifyOAuthBearerTokenOptions,',
      `} from '${ctx.packageName}/better-auth/server'`,
      ...
      'const _authPolicy: CreateBetterConvexAuthOptions<GenericDataModel> = {',
      '  emailAndPassword: { sendResetPassword: async () => undefined },',
      ...
      'const _oauthPrincipal: OAuthLiveAccess = {',
      "  clientId: 'client-id',",
      "  grantId: 'consent-id',",
      ...
      "  subject: 'user-id',",
      '}',
      'const _liveOAuthAccess: Promise<boolean> = _authApi.validateOAuthAccess(_authCtx, _oauthPrincipal)',
      'void mod',
      'void authComponent',
      'void authTest',
      'void register',
