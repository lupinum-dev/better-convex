...
type MissingConvexGeneratedApi = {
   ...
   * Run the file-bound Convex dev command or \`pnpm exec better-convex convex codegen\` to create \`convex/_generated/api\`.
   */
  readonly __betterConvexNuxtError: 'Missing generated Convex API. Run the file-bound Convex dev command or pnpm exec better-convex convex codegen.'
}
  ...
  return new Proxy({} as MissingConvexGeneratedApi, {
    get(_target, prop) {
      ...
      if (prop === '__betterConvexNuxtError') {
        return 'Missing generated Convex API. Run the file-bound Convex dev command or pnpm exec better-convex convex codegen.'
      }
      ...
      throw new Error(
        '[better-convex-nuxt] #convex/api points to a placeholder because convex/_generated/api was not found. ' +
          'Run the file-bound Convex dev command or \`pnpm exec better-convex convex codegen\` to generate your Convex API. ' +
