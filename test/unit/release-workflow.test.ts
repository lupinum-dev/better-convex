    ...
    try {
      ...
      expect(commands.slice(4)).toEqual(
        expect.arrayContaining([
          'scripts/verify-release.mjs --package vue --artifact-manifest .release-artifacts/vue/0.8.0-beta.39/artifact.json',
          'scripts/verify-release.mjs --package nuxt --artifact-manifest .release-artifacts/nuxt/0.8.0-beta.39/artifact.json',
        ]),
      )
    } finally {
