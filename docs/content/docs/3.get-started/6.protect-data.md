...
The middleware waits for auth settlement and redirects anonymous navigation. It always preserves a validated local return path in the `redirect` query parameter.
