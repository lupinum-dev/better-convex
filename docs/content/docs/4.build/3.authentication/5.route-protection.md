...
The middleware always appends a validated local `redirect` query value. Validate and normalize that value again before navigating after sign-in; never accept an external URL.
