...
```bash
pnpm add @lupinum/better-convex-nuxt convex@1.42.2 nuxt@4.5.2 better-auth@1.7.0-rc.2 @better-auth/oauth-provider@1.7.0-rc.2
```
...
| OAuth Provider, optional peer | `1.7.0-rc.2`                       |
