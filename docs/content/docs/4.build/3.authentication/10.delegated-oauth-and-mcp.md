...
The complete application reference is [`starters/mcp-oauth-agent`](https://github.com/lupinum-dev/better-convex/tree/main/starters/mcp-oauth-agent).
...
| `pnpm test:mcp-conformance`       | Stable-SDK contract proof plus published 2025 protocol scenarios              |
...
because it advertises no `2026-07-28` scenarios. Neither path certifies the OAuth
