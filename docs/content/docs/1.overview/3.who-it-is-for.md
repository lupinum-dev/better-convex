...
- Authentication is optional. Omit `convex.auth` for a Convex-only build without Better Auth runtime code.
...
| Nuxt                            | `4.5.2`                             |
| Convex                          | `1.42.2`                            |
| Better Auth, optional peer      | `1.7.2`                             |
| OAuth Provider, optional peer   | `@better-auth/oauth-provider@1.7.2` |
| Better Auth Core, optional peer | `@better-auth/core@1.7.2`           |
| Node.js                         | `^22.19.0` or `^24.11.0`            |

The package manifest is canonical. Stable publication remains blocked until the independent release reviews pass.
