...
| ------------------ | ------------------ | --------------------------------------------- |
| Better Convex Nuxt | 1.0 beta candidate | Nuxt 4.5.2, Convex 1.42.2, Better Auth 1.7 RC |
...
| --------------------------------- | ------------------------------------------------- | ----------------------------------------- | --------------------------------------------------- | ------------------ |
| Nuxt generation                   | Nuxt `4.5.2`                                      | Nuxt module; released types use Nuxt APIs | Documents Nuxt 3                                    | You decide         |
...
| Optimistic updates                | Direct Convex local-store updates                 | Not in the 0.0.6 tarball surface          | Not documented                                      | Application-owned  |
...
| File support                      | Typed single-file upload primitive                | Upload and storage composables            | Not documented                                      | Application-owned  |
...
- [Better Convex Nuxt repository](https://github.com/lupinum-dev/better-convex)
