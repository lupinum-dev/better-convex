...
| ------------------ | ---------------- | --------------------------------------------- |
| Better Convex Nuxt | source candidate | Nuxt 4.5.1, Convex 1.42.2, Better Auth 1.7 RC |
...
| --------------------------------- | ------------------------------------------------- | ----------------------------------------- | --------------------------------------------------- | ------------------ |
| Nuxt generation                   | Nuxt `4.5.1`                                      | Nuxt module; released types use Nuxt APIs | Documents Nuxt 3                                    | You decide         |
