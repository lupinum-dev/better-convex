...
| Import                           | Purpose                                                        |
| -------------------------------- | -------------------------------------------------------------- |
| `better-convex-nuxt`             | Nuxt module and ordinary root types                            |
| `better-convex-nuxt/auth-client` | Advanced Better Auth client definition and inference types     |
| `better-convex-nuxt/convex-auth` | Convex-side Better Auth integration and user projection helper |
...
| ---------------------------- | ------------ | ------------------------------------------------------------------------- |
| `better-convex-vue`          | Beta         | Vue plugin plus query, pagination, mutation, action, and connection state |
| `better-convex-vue/errors`   | Beta         | Framework-neutral sanitized client error contract                         |
| `better-convex-vue/embedded` | Beta         | Frozen token-free runtime attachment for an embedded Vue root             |
| `better-convex-vue/mcp-app`  | Experimental | Official MCP Apps client lifecycle for a sandboxed App iframe             |
...
`better-convex-mcp` is an experimental, provider-neutral resource-server
