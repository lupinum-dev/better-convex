...
Client-only. Returns the frozen `better-convex-vue/embedded` attachment owned by the current Nuxt app for an explicitly embedded Vue application. It contains no credentials or Better Auth controls.
